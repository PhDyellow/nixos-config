{
  ...
  outputs = {self, nixpkgs-unstable, ...}@inputs: {
    nixosModules = {
      ...
      x1carbon-vm = {
        vm-settings = import ./x1carbon-vm/vm-settings.nix;
        boot = import ./x1carbon-vm/boot.nix;
        networking = import ./x1carbon-vm/networking.nix;
        trackpad = import ./x1carbon-vm/trackpad.nix;
        desktop = import ./x1carbon-vm/desktop.nix;
        fs = import ./x1carbon-vm/fs.nix;
        phil_user = import ./x1carbon-vm/phil-user.nix;
      };
      prime-ai = {
        gui = import ./prime-ai/gui.nix;
        cli = import ./prime-ai/cli.nix;

        networking = import ./prime-ai/networking.nix;
        bluetooth = import ./prime-ai/bluetooth.nix;
        hardware_config_tuxedo = import ./prime-ai/hardware-config-tuxedo.nix;
        hardware_config = import ./prime-ai/hardware-config.nix;
        impermanence-agenix = import ./prime-ai/impermanence-agenix.nix;
        impermanence = import ./prime-ai/impermanence.nix;
      ...
      window-managers = {
        ...
        sway-config-vm = {config, pkgs, ...}: {
          ...
          programs.sway.extraOptions =
            let
              custom-config-vm = pkgs.writeTextFile {
                name = "sway-config-vm";
                text = ''
set $mod Mod1
set $term foot
